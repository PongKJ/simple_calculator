  ...
  if(LIST_OF_SANITIZERS)
    if(NOT
      ...
      if(NOT MSVC)
        ...
        target_compile_options(${project} INTERFACE /fsanitize=${LIST_OF_SANITIZERS} /Zi /INCREMENTAL:NO)
        target_compile_definitions(${project} INTERFACE _DISABLE_VECTOR_ANNOTATION _DISABLE_STRING_ANNOTATION)
        target_link_options(${project} INTERFACE /INCREMENTAL:NO)
      endif()
    endif()
  endif()
